...
try:
    ...
    print(
        "Before running sphinx, you must have built and installed"
...
project = u"TOAST"
copyright = u"2015-2020, Theodore Kisner, Reijo Keskitalo, Andrea Zonca"
...
latex_documents = [
    (
        "index",
        "TOAST.tex",
        u"TOAST Documentation",
        u"Theodore Kisner, Reijo Keskitalo, Andrea Zonca",
        "manual",
    )
]
...
man_pages = [
    ("index", "toast", u"TOAST Documentation", [u"Theodore Kisner, Reijo Keskitalo"], 1)
]
...
texinfo_documents = [
    (
        ...
        "TOAST",
        u"TOAST Documentation",
        u"Theodore Kisner, Reijo Keskitalo",
        "TOAST",

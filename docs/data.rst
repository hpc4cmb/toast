...
This class looks like a dictionary of numpy arrays, but the memory is allocated outside
of Python, which means it can be explicitly managed / freed.  This `cache` member is
where alternate flavors of the timestream data are stored.

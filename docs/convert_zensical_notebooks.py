#!/usr/bin/env python3
"""
Based on script from https://github.com/owid/etl

This is a temporary workaround until zensical supports mkdocs-jupyter
functionality.
...
def convert_notebooks(docs_dir: Path, output_dir: Path, verbose: bool):
    ...
    if not output_dir.exists():
        ...
        print("Please run this after building docs (e.g., after 'make docs.build')")
        return
    ...
    if len(notebooks) == 0:
        print(f"No Jupyter notebooks found in directory {docs_dir}")
        return
...
if __name__ == "__main__":
    ...
    convert_notebooks(docs_dir=docs_dir, output_dir=out_dir, verbose=True)

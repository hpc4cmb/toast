...
cmake \
    ...
    -DOPENMP_TARGET_FLAGS="-Minfo=mp -gpu=cc80" \
    ...
    -DDISABLE_FLAC=1 \
    -DBLAS_LIBRARIES="-L${NVHPC_ROOT}/compilers/lib -lblas -lnvf -mp -lrt" \
    -DLAPACK_LIBRARIES="-L${NVHPC_ROOT}/compilers/lib -llapack -lnvf -mp -lrt" \

...
class mpi_atm_sim {
    public:
        ...
        typedef std::shared_ptr <mpi_atm_sim> pshr;
        typedef std::unique_ptr <mpi_atm_sim> puniq;
    ...
    private:
        ...
        long nr;                        // Number of steps in the Kolmogorov
                                        // grid
        long nelem_sim_max;             // Size of the independent X-direction
                                        // slices.

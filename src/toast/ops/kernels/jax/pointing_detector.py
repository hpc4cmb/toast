...
pointing_detector_inner = jax.vmap(pointing_detector_inner, in_axes=[None, 0, 0, None], out_axes=0) # interval_size
pointing_detector_inner = jax.vmap(pointing_detector_inner, in_axes=[None, 0, 0, None], out_axes=0) # intervals
pointing_detector_inner = jax.vmap(pointing_detector_inner, in_axes=[0, None, None, None], out_axes=0) # detectors

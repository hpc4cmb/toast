...
void init_map_cov(py::module &m)
{
    m.def(
        ...
        py::arg("invnpp"), py::arg("hits"), py::arg("zmap"), R"(
    ...
    m.def(
        ...
        py::arg("nsub"), py::arg("nsubpix"), py::arg("nnz"), py::arg("submap"),
        py::arg("subpix"), py::arg("weights"), py::arg("scale"), py::arg("invnpp"), R"(
    ...
    m.def(
        ...
        py::arg("cond"), py::arg("threshold"), py::arg("invert"), R"(

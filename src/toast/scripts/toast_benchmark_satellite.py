...
def parse_arguments():
    ...
    args.max_detector = (
        434  # Hex-packed 1027 pixels (18 rings) times two dets per pixel.
    )
    args.width = 10
...
def main():
    ...
    #job_ops_sim_satellite_apply(job_ops, data)
    job_ops.sim_satellite.apply(data) # TODO this hangs on alvarez

...
from . import ops_scan_alm as test_ops_scan_alm
...
from . import ops_stokes_hwp as test_ops_stokes_hwp
from . import ops_derivatives_weights as test_ops_derivatives_weights
...
def test(name=None, verbosity=2):
    ...
    if name is None:
        ...
        suite.addTest(loader.loadTestsFromModule(test_ops_scan_alm))
        ...
        suite.addTest(loader.loadTestsFromModule(test_ops_stokes_hwp))
        suite.addTest(loader.loadTestsFromModule(test_ops_derivatives_weights))

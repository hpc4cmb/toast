...
namespace toast { namespace atm {
	...
	z0_center, z0_sigma, T0_center, T0_sigma;
      ...
      El::DistMatrix<double> * build_covariance( long ind_start, long ind_stop, bool save_covmat, double scale ); // Use the atmospheric parameters for volume element covariance

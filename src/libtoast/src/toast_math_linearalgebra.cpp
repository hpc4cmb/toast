...
void toast::LinearAlgebra::syev_batched(char JOBZ, char UPLO, int N, double *A_batch,
                                        int LDA, double *W_batch, int *INFO_batch, const int batchCount)
{
#ifdef HAVE_CUDALIBS
    // prepare inputs
    ...
    cusolverStatus_t statusSolver = cusolverDnDsyevjBatched(GPU_memory_pool.handleSolver, jobz_gpu, uplo_gpu, N, A_batch_gpu, LDA, W_batch_gpu, WORK_gpu, LWORK, INFO_batch_gpu, GPU_memory_pool.jacobiParameters, batchCount);
